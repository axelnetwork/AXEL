...
In order to support loading of multiple wallets in axel-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axel.cpp.
...
Changes to axel.cpp
----------------------
axel.cpp is the entry point into axel-qt, and as such, will require some minor modifications to provide hooks for
