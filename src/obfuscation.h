...
{
public:
    /// Is the inputs associated with this public key? (and there is deposit axel amount - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of axel.
