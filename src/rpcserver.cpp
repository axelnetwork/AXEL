...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"axel", "listmasternodes", &listmasternodes, true, true, false},
        {"axel", "getmasternodecount", &getmasternodecount, true, true, false},
        {"axel", "masternodeconnect", &masternodeconnect, true, true, false},
        {"axel", "masternodecurrent", &masternodecurrent, true, true, false},
        {"axel", "masternodedebug", &masternodedebug, true, true, false},
        {"axel", "startmasternode", &startmasternode, true, true, false},
        {"axel", "createmasternodekey", &createmasternodekey, true, true, false},
        {"axel", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"axel", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"axel", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"axel", "getmasternodewinners", &getmasternodewinners, true, true, false},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use axeld, or the -server option to axel-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> axel-cli " + methodname + " " + args + "\n";
}
