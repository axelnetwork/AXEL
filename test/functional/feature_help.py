...
"""Verify that starting axel with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start axel with -? for help text")
        ...
        self.log.info("Start axel with -version for version information")
