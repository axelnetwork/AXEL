...
RESOURCES += src/qt/axel.qrc src/qt/axel_locale.qrc

TRANSLATIONS += src/qt/locale/axel_bg.ts \
                src/qt/locale/axel_de.ts \
                src/qt/locale/axel_en.ts \
                src/qt/locale/axel_es.ts \
                src/qt/locale/axel_fi.ts \
                src/qt/locale/axel_fr.ts \
                src/qt/locale/axel_it.ts \
                src/qt/locale/axel_ja.ts \
                src/qt/locale/axel_pl.ts \
                src/qt/locale/axel_pt.ts \
                src/qt/locale/axel_ru.ts \
                src/qt/locale/axel_sk.ts \
                src/qt/locale/axel_sv.ts \
                src/qt/locale/axel_vi.ts \
                src/qt/locale/axel_zh_CN.ts \
                src/qt/locale/axel_zh_TW.ts
