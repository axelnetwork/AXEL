...
#   c) node1 mines 32 blocks, so now node 0 has 60001 axel, node 1 has 4250 axel, node2 has none.
#   d) node0 sends 601 axel to node2, in two transactions (301 axel, then 300 axel).
